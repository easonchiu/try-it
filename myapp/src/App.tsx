...
function bindRadioGroup<T extends string>(state: FieldState<T>) {
  return {
    value: state.value,
...
const ObserverDemo = observer(function Demo() {
    ...
    >
      <FormControl>
        ...
        <RadioGroup row {...bindRadioGroup(form.$.by)}>
          <FormControlLabel
            label='Phone'
            value={SignInBy.Phone}
            control={<Radio />}
          />
          <FormControlLabel
            label='Password'
            value={SignInBy.Password}
            control={<Radio />}
          />
        </RadioGroup>
      </FormControl>
      {form.value.by === SignInBy.Password && (
        <>
          <TextField
            ...
            margin='normal'
            fullWidth
            {...bindTextField(form.$.byPassword.$.username)}
          />
          <TextField
            label='Password'
            type='password'
            margin='normal'
            fullWidth
            {...bindTextField(form.$.byPassword.$.password)}
          />
        </>
      )}
      {form.value.by === SignInBy.Phone && (
        <>
          <TextField
            ...
            margin='normal'
            fullWidth
            {...bindTextField(form.$.byPhone.$.phone)}
          />
          <TextField
            label='Code'
            margin='normal'
            fullWidth
            {...bindTextField(form.$.byPhone.$.code)}
          />
        </>
      )}
